...
<div class="card shadow mb-4">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered" id="tableRejected" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th>Nama</th>
...
<script>
    ...
    $(document).ready(function() {
        $('#tableRejected').DataTable({
            ...
            "ajax": {
                "dataType": "json",
                "url": "<?php echo base_url(); ?>Rejected/getAllData",
                "type": "POST",
                "data": function(data) {
    ...
    function showDetail(id) {
        console.log(id)
        $.ajax({
            url     : "<?php echo base_url(); ?>Rejected/getDetail",
            type  : "POST",
            data    : {id: id},
			dataType : 'json',
			async : true,
    ...
    function saveUpdate(id) {
        ...
        if(nama == '' || jenis_usaha == '' || provinsi == '' || kota == '' || kecamatan == '' || penanggungjawab == '' || alamat_penanggungjawab == '' || kelurahan == '' ) {
            ...
            $.ajax({
                url     : "<?php echo base_url(); ?>Rejected/editPengajuan",
                type  : "POST",
                data    : data,
                dataType : 'json',
                async : true,
