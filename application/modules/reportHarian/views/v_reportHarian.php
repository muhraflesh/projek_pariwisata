...
<h1 class="h3 mb-3 text-gray-800">Laporan Harian</h1>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="">
                    ...
                    <div class="form-group">
                        <label for="">Total Pengunjung</label>
                        <input type="text" class="form-control" name="pelapor" id="pelapor" placeholder="" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-footer" id="footer-modal-create">
                ...
                <button class="btn btn-primary" type="button" onclick="add()">Kirim</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modalDelete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Klik "Hapus" dibawah jika anda ingin menghapus laporan harian wisata anda.</div>
...
<script>
    ...
    function add(){
        showNotification('sukses tambah', 'bg-success')
    }
